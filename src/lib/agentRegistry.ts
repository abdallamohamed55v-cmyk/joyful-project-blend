...
export const AGENTS: AgentDef[] = [
  ...
  { id: "docs", label: "Docs", mention: "@docs", icon: FileStack, color: "text-indigo-400", bg: "bg-indigo-500/15", description: "قوالب احترافية: تقارير، عقود، أبحاث وأكثر", category: "files" },
