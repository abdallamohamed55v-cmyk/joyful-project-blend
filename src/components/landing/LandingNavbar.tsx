    ...
    columns: [
      {
        title: "AI Creation",
        items: [
          { label: "AI Image Generator", desc: "Create stunning visuals with Megsy Pro", href: "/images" },
          { label: "AI Video Generator", desc: "Generate cinematic videos instantly", href: "/videos" },
      ...
      },
      {
        title: "Productivity",
        items: [
          { label: "File Analysis", desc: "Upload & analyze documents with AI", href: "/chat" },
          { label: "Megsy PR", desc: "Create and ship full-stack apps", href: "/build" },
        ],
      },
    ],
    ...
    columns: [
      {
        title: "Image",
        items: [
          { label: "AI Generator", desc: "Create stunning visuals", href: "/images" },
          { label: "Image Editor", desc: "Modify with precision", href: "/images/studio" },
          { label: "Style Transfer", desc: "Apply unique styles", href: "/images/studio" },
        ],
      },
      {
        title: "Video",
        items: [
          { label: "Text to Video", desc: "Generate from scratch", href: "/videos" },
          { label: "Image to Video", desc: "Animate your photos", href: "/videos/studio" },
          { label: "Video Editor", desc: "AI-powered editing", href: "/videos/studio" },
        ],
      },
      {
        title: "Editing",
        items: [
          ...
          { label: "Background", desc: "Remove or replace bg", href: "/images/tools/bg-remover" },
          { label: "Inpainting", desc: "Fill missing areas", href: "/images/tools/inpaint" },
        ],
      },
      {
        title: "Upscaling",
        items: [
          { label: "Image Upscale", desc: "Enhance resolution", href: "/images/studio" },
          { label: "Video Enhance", desc: "4K video upscaling", href: "/videos/tools/upscale" },
          { label: "Face Restore", desc: "Fix and enhance faces", href: "/images/tools/retouching" },
        ],
      },
    ],
    ...
    columns: [
      {
        ...
        items: [
          ...
          { label: "Pricing", desc: "Plans and credits", href: "/pricing" },
          { label: "Contact", desc: "Reach out to our team", href: "/contact" },
        ],
      },
    ],
  },
