...
const galleryItems = [
  { src: "/showcase/model-1.webp", label: "MEGSY V1", model: "megsy", desc: "Hyper-realistic portraits with cinematic depth" },
  { src: "/showcase/model-6.webp", label: "NANO BANANA 2", model: "nano", desc: "Classical painting style with atmospheric lighting" },
  { src: "/showcase/model-2.webp", label: "FLUX KONTEXT MAX", model: "flux", desc: "The world's leading AI image editing & generation model" },
  { src: "/showcase/model-3.webp", label: "RECRAFT V4", model: "recraft", desc: "Precise vector art & design-ready illustrations", mobileOnly: true },
];
