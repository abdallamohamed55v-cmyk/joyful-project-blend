...
const AuthPage = () => {
  ...
  return (
    <div data-theme="dark" className="relative min-h-screen w-full overflow-hidden bg-background text-foreground">
      {/* Calm backdrop */}
      ...
      {/* Top bar with wordmark + back */}
      <div className="relative z-10 w-full px-6 py-6 flex items-center justify-between max-w-[480px] mx-auto">
        <a
          href="/"
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-6 pb-16 pt-4 min-h-[calc(100vh-88px)]">
        <div className="w-full max-w-[400px]">
          ...
          <AnimatePresence mode="wait">
            ...
            {step === "password" && (
              <motion.div key="password" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.18 }} className="space-y-6">
            ...
            {isOtpStep && (
              <motion.div key={`otp-${step}`} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.18 }} className="space-y-6">
            ...
            {step === "set-password" && (
              <motion.div key="set-password" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.18 }} className="space-y-6">
                <div className="relative">
                  <input
            ...
            {step === "reset-password" && (
              <motion.div key="reset-password" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.18 }} className="space-y-6">
                <div className="relative">
                  <input
                    type={showNewPassword ? "text" : "password"}
            ...
            {step === "forgot-password" && (
              <motion.div key="forgot" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.18 }} className="space-y-6">
          ...
          {/* Footer terms */}
          <p className="mt-12 text-[11px] text-foreground/40 leading-relaxed">
