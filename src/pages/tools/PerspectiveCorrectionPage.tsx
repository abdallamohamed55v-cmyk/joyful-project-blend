...
const PerspectiveCorrectionPage = () => {
  ...
  const download = () => {
    ...
    a.href = resultUrl;
    a.download = `perspective-${Date.now()}.png`;
    a.target = "_blank";
    a.click();
  };
        ...
        <AnimatePresence mode="wait">
            ...
            >
              ...
              >
                <h2 className="font-display text-[10vw] sm:text-[6vw] uppercase leading-[0.95] tracking-tight text-foreground">
                  Straighten <span className="text-primary">every line.</span>
                </h2>
                <p className="mt-2 text-sm text-muted-foreground">
                  Auto-fix tilt, keystone &amp; lens distortion in one tap.
                </p>
              </motion.div>
          ...
          {stage === "processing" && (
            ...
            >
              ...
              <div className="text-sm text-muted-foreground">Aligning perspective…</div>
            </motion.div>
          )}
