...
import heroImg from "@/assets/tool-landing/video-colorizer-v8.jpg";
import samplePoster from "@/assets/video-colorizer-sample-boy-v2.jpg";
  ...
  const handleGenerate = async () => {
    ...
    try {
      const { data, error } = await supabase.functions.invoke("video-tools", {
        body: { tool: "video-colorizer", model: FAL_MODEL, video, style, strength },
      });
