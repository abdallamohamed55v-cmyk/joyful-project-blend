...
import heroImg from "@/assets/tool-landing/video-denoise-v8.jpg";
import samplePoster from "@/assets/noise-reduction-sample-boy-v2.jpg";
...
const VideoDenoisePage = () => {
  ...
  const handleGenerate = async () => {
    ...
    setStage("generating");
    try {
      const model = mode === "audio" ? FAL_MODEL_AUDIO : FAL_MODEL_VIDEO;
      const { data, error } = await supabase.functions.invoke("video-tools", {
        body: { tool: "video-denoise", model, video, mode, strength },
      });
            ...
            >
              <div className="flex-1 overflow-y-auto px-4 pt-[calc(env(safe-area-inset-top)+4rem)] pb-[180px]">
                ...
                <div className="max-w-sm mx-auto">
                  <h3 className="mb-2 text-[11px] font-bold tracking-[0.18em] text-white/60 uppercase">Target</h3>
