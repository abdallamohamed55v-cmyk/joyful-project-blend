...
export default function MegsyPrSecurityPage() {
  ...
  function sendToChat(prompt: string) {
    ...
    navigate(`/megsy-pr/${projectId}?prompt=${encodeURIComponent(prompt)}&autosend=1`);
  }
  ...
  return (
    <div className="min-h-[100dvh] bg-background text-foreground flex flex-col">
      <button
        onClick={() => navigate(`/megsy-pr/${projectId}`)}
        aria-label="Back"
        ...
        <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4" onClick={() => setIgnoreFor(null)}>
          <div onClick={(e) => e.stopPropagation()} className="bg-background rounded-2xl w-full max-w-sm p-5">
            ...
            <textarea
              ...
              placeholder="Why is this not applicable? (optional, helps future scans)"
              rows={4}
