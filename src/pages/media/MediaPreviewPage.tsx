...
const MediaPreviewPage = () => {
  ...
  return (
    <AppLayout onSelectConversation={() => {}} onNewChat={() => {}} activeConversationId={null}>
      <div className="min-h-screen w-full bg-gradient-to-b from-black via-zinc-950 to-black flex flex-col">
        {/* Top bar */}
        <div className="sticky top-0 z-20 px-4 pt-4 pb-3">
          <div className="flex items-center justify-between">
            <button
              onClick={() => navigate(-1)}
              className="w-10 h-10 rounded-full flex items-center justify-center bg-white/[0.06] backdrop-blur-3xl backdrop-saturate-200 border border-white/15 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.18),0_8px_24px_-8px_rgba(0,0,0,0.6)]"
            >
              <ArrowLeft className="w-5 h-5 text-white" />
            </button>
            <div className="px-3 py-1.5 rounded-full bg-white/[0.06] backdrop-blur-3xl backdrop-saturate-200 border border-white/15">
        ...
        {item.prompt && (
          <div className="px-4 pb-3">
            <div className="mx-auto max-w-2xl px-4 py-3 rounded-2xl bg-white/[0.05] backdrop-blur-3xl backdrop-saturate-200 border border-white/10">
              <p className="text-[13px] text-white/80 leading-relaxed line-clamp-3">{item.prompt}</p>
            </div>
          </div>
        )}
        ...
        <div className="sticky bottom-0 z-20 px-4 pb-6 pt-2">
          <div className="mx-auto max-w-2xl flex items-center gap-2 p-2 rounded-full bg-white/[0.06] backdrop-blur-3xl backdrop-saturate-200 border border-white/15 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.22),0_20px_50px_-15px_rgba(0,0,0,0.7)]">
            <button
              onClick={handleDownload}
              className="flex-1 flex items-center justify-center gap-2 h-11 rounded-full bg-white text-black font-semibold text-sm active:scale-[0.97] transition-transform"
            >
            ...
            <button
              onClick={handleShare}
              className="flex-1 flex items-center justify-center gap-2 h-11 rounded-full bg-white/10 border border-white/15 text-white font-semibold text-sm active:scale-[0.97] transition-transform"
            >
