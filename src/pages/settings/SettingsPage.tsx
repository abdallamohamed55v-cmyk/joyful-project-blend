...
import {
  ...
  MemoryIcon, SkillsIcon, LanguageIcon, NotificationsIcon, ApiIcon,
  ...
  const sections: Array<{
    ...
    },
    {
      ...
      items: [
        ...
        { icon: ApiIcon, label: "APIs", desc: "Developer access", path: "https://api.megsyai.com", external: true },
      ],
    },
    {
      title: "Support",
      ...
      <div className="max-w-lg mx-auto pb-16 px-5">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          ...
          <button
            ...
            className="w-full flex items-center gap-4 py-5 text-left transition-all active:scale-[0.99]"
          >
            {avatarUrl ? (
          ...
          <WorkspaceSwitcher align="center" side="bottom">
            <button className="w-full flex items-center gap-3 py-3.5 text-left border-t border-border/40">
          ...
          <div className="mt-8 mb-10 space-y-2.5">
            {(() => {
          ...
          {sections.map((section, sIdx) => (
            <motion.div
              ...
              className="mb-9"
            >
              <p className="text-[10px] font-medium uppercase tracking-[0.18em] text-muted-foreground/60 mb-2 px-1">
                {section.title}
              </p>
              <div>
                {section.items.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full flex items-center gap-3.5 py-4 text-left hover:bg-muted/30 -mx-2 px-2 rounded-xl transition-colors"
                    >
