...
const LANGUAGES: Lang[] = [
  ...
  { code: "ar", name: "Arabic", native: "العربية", country: "eg", rtl: true },
  ...
  { code: "fa", name: "Persian", native: "فارسی", country: "ir", rtl: true },
  { code: "ps", name: "Pashto", native: "پښتو", country: "af", rtl: true },
