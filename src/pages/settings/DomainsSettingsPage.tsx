    ...
    <div className="min-h-screen ios26-bg" dir="rtl">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold">جميع الدومينات</h1>
            <p className="text-sm text-muted-foreground mt-1">الدومينات المخصصة لكل مشاريعك</p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="ios26-glass rounded-2xl p-12 text-center text-muted-foreground">
            ...
            <p className="mb-4">لا توجد دومينات مخصصة بعد</p>
            <p className="text-xs">افتح أي مشروع وأضف دومين من إعداداته</p>
          </div>
        ) : (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                      مشروع: {d.projects?.name || "بدون اسم"}
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <Badge variant={d.verification_status === "active" ? "default" : "secondary"}>
                    {d.verification_status === "active" ? "مفعّل" : "قيد التحقق"}
                  </Badge>
                  <Link to={`/megsy-pr/${d.project_id}/domains`}>
                    <Button size="sm" variant="outline" className="rounded-xl">إدارة</Button>
                  </Link>
                </div>
              </div>
            ))}
