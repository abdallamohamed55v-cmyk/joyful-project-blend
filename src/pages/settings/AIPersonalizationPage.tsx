  ...
  return (
    <div className="min-h-screen bg-background pb-28">
      ...
      <div className="max-w-2xl mx-auto px-5 pt-6 space-y-6">
        ...
        {/* Preferred model — kept visible, it's the most relevant */}
        ...
        <Collapsible title="About you" hint={callName || profession ? "Personalized" : "Optional"}>
        ...
        <Collapsible title="Advanced custom instructions" hint={aiTraits || customInstructions ? "Set" : "Optional"}>
      ...
      <div className="fixed bottom-0 inset-x-0 z-40 backdrop-blur-xl bg-background/90 border-t border-border/50 p-4">
        <div className="max-w-2xl mx-auto">
          <button
            onClick={save}
            disabled={saving}
            className="w-full h-11 rounded-xl bg-foreground text-background font-semibold text-sm hover:opacity-90 disabled:opacity-50 transition-opacity flex items-center justify-center gap-2"
          >
